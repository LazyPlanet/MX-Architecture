...
const ROOM_MODEL_TYPE ROOM_MODEL_TYPE_MAX = ROOM_MODEL_TYPE_MULTIPLE;
...
enum ROOM_EXTEND_TYPE {
  ROOM_EXTEND_TYPE_ZHANLIHU = 1,
  ROOM_EXTEND_TYPE_JIAHU = 2,
  ROOM_EXTEND_TYPE_XUANFENGGANG = 3,
  ROOM_EXTEND_TYPE_BAOPAI = 4,
  ROOM_EXTEND_TYPE_DUANMEN = 5,
  ROOM_EXTEND_TYPE_QIYISE = 6
};
bool ROOM_EXTEND_TYPE_IsValid(int value);
const ROOM_EXTEND_TYPE ROOM_EXTEND_TYPE_MIN = ROOM_EXTEND_TYPE_ZHANLIHU;
const ROOM_EXTEND_TYPE ROOM_EXTEND_TYPE_MAX = ROOM_EXTEND_TYPE_QIYISE;
...
enum PAI_OPER_TYPE {
  ...
  PAI_OPER_TYPE_GANGPAI = 3,
  PAI_OPER_TYPE_PENGPAI = 4,
  PAI_OPER_TYPE_CHIPAI = 5,
  PAI_OPER_TYPE_GIVEUP = 6,
  PAI_OPER_TYPE_XUANFENG_FENG = 7,
  PAI_OPER_TYPE_XUANFENG_JIAN = 8,
...
const PAI_OPER_TYPE PAI_OPER_TYPE_MAX = PAI_OPER_TYPE_LIUJU;
...
class PlayerProp : public ::google::protobuf::Message {
 public:
  ...
  // optional bool has_tinged = 9;
  inline bool has_has_tinged() const;
  inline void clear_has_tinged();
  static const int kHasTingedFieldNumber = 9;
  inline bool has_tinged() const;
  inline void set_has_tinged(bool value);

  // optional int32 oper_count_tingpai = 10;
  inline bool has_oper_count_tingpai() const;
  inline void clear_oper_count_tingpai();
  static const int kOperCountTingpaiFieldNumber = 10;
  inline ::google::protobuf::int32 oper_count_tingpai() const;
  inline void set_oper_count_tingpai(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_oper_count_tingpai();
  inline void clear_has_oper_count_tingpai();
  ...
  ::google::protobuf::int32 oper_count_tingpai_;
  friend void  protobuf_AddDesc_P_5fProtocol_2eproto();
  friend void protobuf_AssignDesc_P_5fProtocol_2eproto();
  friend void protobuf_ShutdownFile_P_5fProtocol_2eproto();
...
class GameRecord_GameElement_DetailElement : public ::google::protobuf::Message {
 public:
  ...
  // optional .Adoter.Asset.FAN_TYPE fan_type = 2;
...
class GameRecord_GameElement : public ::google::protobuf::Message {
 public:
  ...
  // repeated .Adoter.Asset.GameRecord.GameElement.DetailElement details = 3;
...
class RoomHistory : public ::google::protobuf::Message {
 public:
  ...
  // repeated .Adoter.Asset.GameRecord list = 2;
  inline int list_size() const;
  inline void clear_list();
...
class CommonProp : public ::google::protobuf::Message {
 public:
  ...
  // optional .Adoter.Asset.GENDER_TYPE gender = 6 [default = GENDER_TYPE_MAN];
...
class RoomOptions : public ::google::protobuf::Message {
 public:
  ...
  // optional int32 open_rands = 4 [default = 4];
...
class RandomSaizi : public ::google::protobuf::Message {
 public:
  ...
  // optional int64 plate_id = 3;
  inline bool has_plate_id() const;
  inline void clear_plate_id();
  static const int kPlateIdFieldNumber = 3;
  inline ::google::protobuf::int64 plate_id() const;
  inline void set_plate_id(::google::protobuf::int64 value);

  // optional int32 random_result = 4;
  inline bool has_random_result() const;
  inline void clear_random_result();
  static const int kRandomResultFieldNumber = 4;
  inline ::google::protobuf::int32 random_result() const;
  inline void set_random_result(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_plate_id();
  inline void clear_has_plate_id();
  inline void set_has_random_result();
  inline void clear_has_random_result();
  ...
  ::google::protobuf::int32 random_result_;
  friend void  protobuf_AddDesc_P_5fProtocol_2eproto();
  friend void protobuf_AssignDesc_P_5fProtocol_2eproto();
  friend void protobuf_ShutdownFile_P_5fProtocol_2eproto();
...
class GameCalculate : public ::google::protobuf::Message {
 public:
  ...
  // optional .Adoter.Asset.GameRecord record = 2;
...
// optional int32 oper_count_tingpai = 10;
inline bool PlayerProp::has_oper_count_tingpai() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void PlayerProp::set_has_oper_count_tingpai() {
  _has_bits_[0] |= 0x00000200u;
}
inline void PlayerProp::clear_has_oper_count_tingpai() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void PlayerProp::clear_oper_count_tingpai() {
  oper_count_tingpai_ = 0;
  clear_has_oper_count_tingpai();
}
inline ::google::protobuf::int32 PlayerProp::oper_count_tingpai() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.PlayerProp.oper_count_tingpai)
  return oper_count_tingpai_;
}
inline void PlayerProp::set_oper_count_tingpai(::google::protobuf::int32 value) {
  set_has_oper_count_tingpai();
  oper_count_tingpai_ = value;
  // @@protoc_insertion_point(field_set:Adoter.Asset.PlayerProp.oper_count_tingpai)
}
...
inline ::Adoter::Asset::FAN_TYPE GameRecord_GameElement_DetailElement::fan_type() const {
...
inline void GameRecord_GameElement_DetailElement::set_fan_type(::Adoter::Asset::FAN_TYPE value) {
...
// repeated int64 room_history = 13;
inline int CommonProp::room_history_size() const {
  return room_history_.size();
}
inline void CommonProp::clear_room_history() {
  room_history_.Clear();
}
inline ::google::protobuf::int64 CommonProp::room_history(int index) const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.CommonProp.room_history)
  return room_history_.Get(index);
}
inline void CommonProp::set_room_history(int index, ::google::protobuf::int64 value) {
  room_history_.Set(index, value);
  // @@protoc_insertion_point(field_set:Adoter.Asset.CommonProp.room_history)
}
inline void CommonProp::add_room_history(::google::protobuf::int64 value) {
  room_history_.Add(value);
  // @@protoc_insertion_point(field_add:Adoter.Asset.CommonProp.room_history)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
CommonProp::room_history() const {
  // @@protoc_insertion_point(field_list:Adoter.Asset.CommonProp.room_history)
  return room_history_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
CommonProp::mutable_room_history() {
  // @@protoc_insertion_point(field_mutable_list:Adoter.Asset.CommonProp.room_history)
  return &room_history_;
}
...
// optional int64 plate_id = 3;
inline bool RandomSaizi::has_plate_id() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void RandomSaizi::set_has_plate_id() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RandomSaizi::clear_has_plate_id() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RandomSaizi::clear_plate_id() {
  plate_id_ = GOOGLE_LONGLONG(0);
  clear_has_plate_id();
}
inline ::google::protobuf::int64 RandomSaizi::plate_id() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.RandomSaizi.plate_id)
  return plate_id_;
}
inline void RandomSaizi::set_plate_id(::google::protobuf::int64 value) {
  set_has_plate_id();
  plate_id_ = value;
  // @@protoc_insertion_point(field_set:Adoter.Asset.RandomSaizi.plate_id)
}

// optional int32 random_result = 4;
inline bool RandomSaizi::has_random_result() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void RandomSaizi::set_has_random_result() {
  _has_bits_[0] |= 0x00000008u;
}
inline void RandomSaizi::clear_has_random_result() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void RandomSaizi::clear_random_result() {
  random_result_ = 0;
  clear_has_random_result();
}
inline ::google::protobuf::int32 RandomSaizi::random_result() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.RandomSaizi.random_result)
  return random_result_;
}
inline void RandomSaizi::set_random_result(::google::protobuf::int32 value) {
  set_has_random_result();
  random_result_ = value;
...
inline ::Adoter::Asset::PAI_OPER_TYPE PaiOperationList::oper_list(int index) const {
...
inline void PaiOperationList::set_oper_list(int index, ::Adoter::Asset::PAI_OPER_TYPE value) {
  assert(::Adoter::Asset::PAI_OPER_TYPE_IsValid(value));
  oper_list_.Set(index, value);
  // @@protoc_insertion_point(field_set:Adoter.Asset.PaiOperationList.oper_list)
}
inline void PaiOperationList::add_oper_list(::Adoter::Asset::PAI_OPER_TYPE value) {
  assert(::Adoter::Asset::PAI_OPER_TYPE_IsValid(value));
