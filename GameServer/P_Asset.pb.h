...
enum FAN_TYPE {
  ...
  FAN_TYPE_JIN_BAO = 17,
  FAN_TYPE_ZHAN_LI = 18,
  FAN_TYPE_DUAN_MEN = 19,
  FAN_TYPE_XUAN_FENG_GANG = 20,
  FAN_TYPE_JIA_HU_NORMAL = 21,
  FAN_TYPE_JIA_HU_MIDDLE = 22,
  FAN_TYPE_JIA_HU_HIGHER = 23
};
bool FAN_TYPE_IsValid(int value);
const FAN_TYPE FAN_TYPE_MIN = FAN_TYPE_ZHUANG;
const FAN_TYPE FAN_TYPE_MAX = FAN_TYPE_JIA_HU_HIGHER;
...
class CommonConst : public ::google::protobuf::Message {
 public:
  ...
  // optional int32 model_release = 3;
  inline bool has_model_release() const;
  inline void clear_model_release();
  static const int kModelReleaseFieldNumber = 3;
  inline ::google::protobuf::int32 model_release() const;
  inline void set_model_release(::google::protobuf::int32 value);

  // optional int32 max_cards_count = 4 [default = 136];
  inline bool has_max_cards_count() const;
  inline void clear_max_cards_count();
  static const int kMaxCardsCountFieldNumber = 4;
  inline ::google::protobuf::int32 max_cards_count() const;
  inline void set_max_cards_count(::google::protobuf::int32 value);

  // optional int32 player_count = 5 [default = 4];
  ...
  // optional int64 daily_sign_id = 9;
  inline bool has_daily_sign_id() const;
  inline void clear_daily_sign_id();
  static const int kDailySignIdFieldNumber = 9;
  inline ::google::protobuf::int64 daily_sign_id() const;
  inline void set_daily_sign_id(::google::protobuf::int64 value);

  // optional int64 fan_id = 10;
  inline bool has_fan_id() const;
  inline void clear_fan_id();
  static const int kFanIdFieldNumber = 10;
  inline ::google::protobuf::int64 fan_id() const;
  inline void set_fan_id(::google::protobuf::int64 value);
 ...
 private:
  ...
  inline void set_has_common_prop();
  inline void clear_has_common_prop();
  inline void set_has_model_release();
  inline void clear_has_model_release();
  ...
  ::Adoter::Asset::AssetCommonProp* common_prop_;
  int type_t_;
  ::google::protobuf::int32 model_release_;
...
class RoomFan : public ::google::protobuf::Message {
 public:
  ...
  // optional int32 fans_count = 3 [default = 25];
...
// optional int32 model_release = 3;
inline bool CommonConst::has_model_release() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void CommonConst::set_has_model_release() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CommonConst::clear_has_model_release() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void CommonConst::clear_model_release() {
  model_release_ = 0;
  clear_has_model_release();
}
inline ::google::protobuf::int32 CommonConst::model_release() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.CommonConst.model_release)
  return model_release_;
}
inline void CommonConst::set_model_release(::google::protobuf::int32 value) {
  set_has_model_release();
  model_release_ = value;
  // @@protoc_insertion_point(field_set:Adoter.Asset.CommonConst.model_release)
}
...
// optional int32 player_count = 5 [default = 4];
inline bool CommonConst::has_player_count() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void CommonConst::set_has_player_count() {
  _has_bits_[0] |= 0x00000010u;
}
inline void CommonConst::clear_has_player_count() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void CommonConst::clear_player_count() {
  player_count_ = 4;
  clear_has_player_count();
}
inline ::google::protobuf::int32 CommonConst::player_count() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.CommonConst.player_count)
  return player_count_;
}
inline void CommonConst::set_player_count(::google::protobuf::int32 value) {
  set_has_player_count();
  player_count_ = value;
  // @@protoc_insertion_point(field_set:Adoter.Asset.CommonConst.player_count)
}
...
// optional int64 fan_id = 10;
inline bool CommonConst::has_fan_id() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void CommonConst::set_has_fan_id() {
  _has_bits_[0] |= 0x00000200u;
}
inline void CommonConst::clear_has_fan_id() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void CommonConst::clear_fan_id() {
  fan_id_ = GOOGLE_LONGLONG(0);
  clear_has_fan_id();
}
inline ::google::protobuf::int64 CommonConst::fan_id() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.CommonConst.fan_id)
  return fan_id_;
}
inline void CommonConst::set_fan_id(::google::protobuf::int64 value) {
  set_has_fan_id();
  fan_id_ = value;
  // @@protoc_insertion_point(field_set:Adoter.Asset.CommonConst.fan_id)
}
